...
contract MedicalStorage {
    ...
    function addDoctor(address _doctorAddress) public {
        ...
        require(
            ...
            "The patient address cannot be equal to the doctor's address"
        );
        require(
    ...
    function findDoctorIndex(
        ...
        return -1; // Explicitly return -1 if the doctor address is not found
    }
    ...
    function findPatientIndex(
        ...
        return -1; // Explicitly return -1 if the patient address is not found
    }
